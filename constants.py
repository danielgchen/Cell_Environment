...
def instantiate_from_distribution(**kwargs):
    ...
    value = adjust_value(value, kwargs['llimit'], kwargs['ulimit'], kwargs['continous'])  # adjust the value accordingly
    return value
...
cell_instantiation_information = {
    ...
    'cell_vision_radius': [instantiate_from_distribution, {'distribution':np.random.normal, 'distribution_params':{'loc':cell_vision_radius_mean, 'scale':cell_vision_radius_std}, 'llimit':cell_vision_radius_llimit, 'ulimit':cell_cycle_ulimit, 'continous':False}],
    'cell_vision_nconsidered': [instantiate_from_distribution, {'distribution':np.random.normal, 'distribution_params':{'loc':cell_vision_nconsidered_mean, 'scale':cell_vision_nconsidered_std}, 'llimit':cell_vision_nconsidered_llimit, 'ulimit':cell_cycle_ulimit, 'continous':False}],
    'cell_mutational_rate': [instantiate_from_distribution, {'distribution':np.random.normal, 'distribution_params':{'loc':cell_mutational_rate_mean, 'scale':cell_mutational_rate_std}, 'llimit':cell_mutational_rate_llimit, 'ulimit':cell_cycle_ulimit, 'continous':False}],
}
